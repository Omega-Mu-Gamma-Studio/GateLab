...
import useHazardStore from './hazardStore.js'
...
export const useCanvasStore = create((set, get) => ({
  ...
  loadPhase(phaseData, phaseName) {
    ...
    // New phase, new topology — Hazard panel re-derives critical path and
    // clears any stale simulation from the previous phase.
    useHazardStore.getState().reset(nodes, wires, inputs)
  },
  ...
  toggleInput(nodeId) {
    ...
    useHazardStore.getState().record(inputs, next)
  },
